...
/**
 * NOTE ON TRACKING (Aug 2026)
 * --------------------------
 * GTM above is the ONLY tracking installed on this page, by design.
 *
 * A direct Google Ads conversion pixel (gtag.js configured for the Ads account
 * plus a conversion snippet on /thank-you) used to live here. It was removed so
 * conversion tracking has a single source of truth: the container fires the Ads
 * tag off the `form_submit_success` dataLayer event instead.
 *
 * Do not re-add a gtag.js snippet here. If Ads or GA4 need to fire, configure
 * the tag inside GTM-WLNN5FJV - adding it in both places double-counts every
 * conversion, which is the exact problem this consolidation removed.
 */
