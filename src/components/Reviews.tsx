...
/** Exported for GoogleReviewBadge, which reuses the same amber star icons. */
 ...
 */
/** Exported for GoogleReviewBadge, which needs the same mark at a smaller size. */
 ...
 */
/**
 * Rendered once, at every width. It was previously placed twice with each copy
 * gated to a single breakpoint so mobile could show reviews earlier; mobile and
 * desktop now share one section order, so a single unconditional copy says the
 * same thing without the duplicate markup.
 */
