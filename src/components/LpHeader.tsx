    ...
    <header className="sticky top-0 z-50 w-full border-b border-beige/80 bg-white/90 backdrop-blur-md">
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-3 px-3 py-2.5 sm:px-6 sm:py-3">
        {/* Brand links to the top of this page, not out to the main site - the
            LP lives on its own subdomain (clearcorrect.hamptonfamilydentist.com)
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-3">
          ...
          {/* An anchor to #consult, not a modal.
              Handoff A1 specifies "Primary button: Free Consultation (anchors
              to the form, #consult)". The sister page opens a dialog because
              its form sits far down the page; here the form is the first thing
              beside the hero, so scrolling to it shows the visitor what they
              are filling in - a modal would hide the "what's included" list
              that does the reassuring at this price point.

              BookingProvider is still mounted for the OfferBand's dialog, so
              `open` remains available - it is simply not the right interaction
              for the header. */}
          <a
            href="#consult"
